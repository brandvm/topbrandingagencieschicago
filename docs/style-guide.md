# Top Branding Agencies Chicago — visual style guide

[Open the protected style guide](https://topbrandingagencieschicago-staging.hamoun-ce6.workers.dev/design/) · [Screenshot reference board](https://topbrandingagencieschicago-staging.hamoun-ce6.workers.dev/design/references/)

Bold city publication: Condensed masthead · cobalt rank numbers · square geometry.
